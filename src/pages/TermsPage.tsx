        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="space-y-10 text-slate-300 text-sm sm:text-base leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 space-y-2 text-sm text-slate-300">
            ...
            <section className="space-y-3">
              ...
              <p>
                The Campus Saathi application name, logo, user interface designs, and code are the intellectual property of Abhay Kushwaha and the Campus Saathi development team. You may not copy, reproduce, or redistribute our brand assets without explicit written authorization.
              </p>
            </section>
