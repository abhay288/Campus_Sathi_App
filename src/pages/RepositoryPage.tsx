        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="p-8 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {taxonomy.map((item, idx) => (
                <div key={idx} className="p-5 rounded-xl bg-slate-50 border border-slate-200 space-y-1.5 shadow-xs">
                  <div className="text-xs font-bold text-brand-600 uppercase tracking-wider">Step 0{idx + 1}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-7 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-3">
              ...
              <h3 className="text-base font-bold text-slate-900">Quality-Checked Submissions</h3>
            ...
            <div className="p-7 rounded-2xl bg-white border border-brand-200 shadow-sm space-y-3">
              <div className="flex items-center space-x-2 text-brand-700 font-bold text-sm">
                <ShieldAlert className="w-4 h-4" />
                <span>Responsible Content Policy</span>
              </div>
              <h3 className="text-base font-bold text-slate-900">Respect for Copyright & Fair Use</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
